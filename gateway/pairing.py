    ...
    def _load_json(self, path: Path) -> dict:
        if path.exists():
            try:
                ...
                # pairing file that is not valid UTF-8 would otherwise escape
                # this handler and take the gateway's auth path down. An
                # undecodable pairing file is treated as an empty one.
                return {}
        return {}
